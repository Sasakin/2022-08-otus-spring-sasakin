...
public class BookRepositoryJPATest {
    ...
    public void testUpdate() {
        ...
        Book fromBDBook = bookRepositoryJPA.findById(book.getId()).orElse(null);
    ...
    public void testDelete() {
        ...
        Assert.isNull(bookRepositoryJPA.findById(id).orElse(null), "Book is deleted");
    ...
    public void testGetById() {
        ...
        Assert.notNull(bookRepositoryJPA.findById(id).orElse(null), "");
    }
