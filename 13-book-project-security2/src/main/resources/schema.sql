...
drop
constraint if exists FK6xpmpddanwk8vq96sax69c4hu;


alter table if exists books
drop
constraint if exists FKfjixh2vym2cvfj3ufxj91jem7;


alter table if exists books
drop
constraint if exists FK9hsvoalyniowgt8fbufidqj3x;
...
alter table if exists users
    add constraint UK_bjvsqv7pyof67ud2ys7vff2y5 unique (login);
